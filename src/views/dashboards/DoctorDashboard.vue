  ...
  <div class="dashboard">
    ...
    <div class="dashboard-header">
      <div class="header-info">
        ...
        <div class="user-info">
          LOGGED IN AS: {{ authStore.user?.displayName || 'USER' }}: DOCTOR
        </div>
      </div>
        ...
        <div class="welcome-section">
          <div class="welcome-card">
            <div class="client-logo">
              <mdi-icon :path="mdiHospitalBuilding" size="64" color="#0066B2" />
            </div>
            ...
            <div class="doctor-stats">
              ...
              <div class="stat-item">
                <span class="stat-number">{{ todayStats.prescriptions }}</span>
